...
- (id) init
{
	...
	_connector = [[ServerConnector alloc] initWithUrlPrefix:@"http://localhost:3000"];
    //_connector = [[ServerConnector alloc] initWithUrlPrefix:@"http://baltazar.fesb.hr/~lana/bvisible"];
                                    ...
                                    phone:(NSString *)phone
{
    ...
    [_connector createProfileForPerson:person];
